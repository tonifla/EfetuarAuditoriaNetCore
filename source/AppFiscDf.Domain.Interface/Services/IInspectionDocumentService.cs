...
namespace AppFiscDf.Domain.Interface.Services
{
    ...
    {
        Task<IEnumerable<InspectionDocumentRequestResponse>> ListByInspectionDocumentAsync(bool finished, decimal inspectionAgentId, DateTime startDate, DateTime endDate, decimal sequentialCode, string cpfCnpj, string companyName);

        Task<IEnumerable<InspectionDocumentReducedResponse>> ListByInspectionDocumentAsync(decimal inspectionAgentId, bool finished);

        Task<IEnumerable<InspectionDocumentRequestResponse>> ListByInspectionDocumentAsync(int typeInspectionDocument, decimal inspectionAgentId, DateTime startDate, DateTime endDate, decimal sequentialCode, string economicAgentCpfCnpj, string economicAgentCompanyName, decimal nrUfId, string ufAcronym, decimal orderServiceYear, decimal orderServiceNumber, int page);

        Task<InspectionDocumentRequestResponse> FindByInspectionDocumentAsync(decimal inspectionDocumentId);

        Task<InspectionDocumentRequestResponse> FindByInspectionDocumentAsync(decimal inspectionAgentId, decimal sequentialCode, bool finished);
